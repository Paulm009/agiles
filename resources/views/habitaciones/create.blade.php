            ...
            <div class="row">
                <div class="card" style="border:none;">
                    ...
                    <div class="alert alert-danger">
                        <strong>Whoops!</strong> Error en los datos de entrada.<br><br>
                        <ul>
                    ...
                    @endif
                    <div class="card-body">
                        <form class="flex justify-content-center g-3 bg-dark" method="post" action="{{url('listaHabitacion')}}"  enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-auto mb-2">
                                ...
                                <div class="input-group">
                                    <input value="{{old('estado')}}" type="text" class="form-control @error('estado') is-invalid @enderror" name="estado" id="estado">
